          ...
          <aside>
            ...
            <aside>
              ...
              <ul className={styles.list}>
                ...
                <span className={styles.listItem}>Barbecue</span>
                <span className={styles.listItem}>Gainesville</span>
                <span className={styles.listItem}>Food Truck</span>
            ...
            <aside>
              ...
              <ul className={styles.list}>
                ...
                <aside className={`${styles.contactItem} ${styles.listItem}`}>
                  ...
                  <a href="https://maps.app.goo.gl/Xm4sL1fiU3k3SxyY9" target="_blank">{process.env.NEXT_PUBLIC_BUSINESS_CITY_STATE}</a>
                </aside>
